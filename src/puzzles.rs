...
//!
//! Hardcodes the 77 unsolved BTC puzzles as a JSON string literal.  Each puzzle
...
mod tests {
    ...
    #[test]
    fn puzzle_set_has_77() {
        assert_eq!(puzzle_set().len(), 77);
    }
    ...
    fn gap_bits_are_none() {
        ...
        let occupied: std::collections::HashSet<usize> = ps.ranges()
            ...
            .collect();
        // The known gaps (solved puzzles): 75, 80, 85, 90, 95, 100, 105, 110, 115, 120, 125, 130, 135
        for gap in [75usize, 80, 85, 90, 95, 100, 105, 110, 115, 120, 125, 130, 135] {
    ...
    fn pick_distribution_chi_squared() {
        ...
        // Degrees of freedom ≈ 76, critical value at p=0.001 is ~120.
